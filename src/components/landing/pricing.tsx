          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className='mb-6'>
                ...
                <p className={cn('text-sm', plan.popular ? 'text-gray-300' : 'text-gray-600')}>
                  {plan.description}
                </p>
              </div>
              ...
              <div className='mb-6'>
                ...
                <span className={cn('text-sm', plan.popular ? 'text-gray-300' : 'text-gray-600')}>
                  {plan.period}
                </span>
              </div>
              ...
              <ul className='space-y-3 mb-8'>
                {plan.features.map((feature) => (
                  <li key={feature} className='flex items-start gap-3'>
                    ...
                    />
                    <span
                      className={cn('text-sm', plan.popular ? 'text-gray-200' : 'text-gray-600')}
                    >
                      {feature}
                    </span>
                  </li>
