...
const features = [
  {
    ...
    description: 'Our intelligent algorithm considers hundreds of constraints to generate the perfect roster every time.',
    color: 'blue',
  },
  {
    icon: Calendar,
    title: 'Flexible Scheduling',
    description: 'Support for day shifts, night shifts, rotating patterns, and custom shift definitions.',
    color: 'purple',
  },
  {
    icon: Shield,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Orto AI combines powerful optimization with an intuitive interface 
            to make roster management effortless.
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Built specifically for the complexities of healthcare scheduling, 
                Orto AI understands the unique challenges of managing nursing rosters.
              </p>
