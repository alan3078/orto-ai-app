    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure minimum and maximum working hours per month for each shift type.
            These settings apply as defaults when creating rosters.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>
              Edit Working Hours - {editingConfig?.name}
            </DialogTitle>
            <DialogDescription>
          ...
          <DialogFooter>
            ...
            <Button
              onClick={handleSave}
              disabled={updateMutation.isPending || minHours > maxHours}
            >
