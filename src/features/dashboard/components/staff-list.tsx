        ...
        {isLoading ? (
          ...
          <div className='max-h-[400px] overflow-y-auto border rounded-md'>
            <Table>
              ...
              <TableBody>
                {filtered.map((s) => (
                  <TableRow key={s.id} className={cn(!s.isActive && 'opacity-50 bg-muted/30')}>
                    <TableCell>
                      <div className='flex items-center gap-2'>
                        <Switch
                          checked={s.isActive}
                          onCheckedChange={() =>
                            handleToggleActive(s.id, getStaffName(s), s.isActive)
                          }
                    ...
                    <TableCell className='text-right'>
                      <div className='flex justify-end gap-1'>
                        <Button size='icon' variant='ghost' onClick={() => setEditingStaff(s)}>
