...
import { getRoleDisplayName, getRoleDescription, getActionDisplayName } from '@/lib/permissions';
  ...
  const handleToggle = async (permissionId: string, role: UserRole, currentlyGranted: boolean) => {
    ...
    setLocalPermissionMap((prev) => {
      ...
      if (currentlyGranted) {
        return {
          ...prev,
          [permissionId]: currentRoles.filter((r) => r !== role),
        };
      } else {
        ...
        <TabsContent value='matrix' className='mt-4'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Click toggles to grant or revoke permissions. Super Admin permissions cannot be
                changed.
              </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <TableCell key={role} className='text-center'>
                              {isLoading ? (
                                ...
                                <Switch
                                  ...
                                  onCheckedChange={() =>
                                    handleToggle(permission.id, role, isGranted)
                                  }
      ...
      <Card>
        ...
        <CardContent>
          <ul className='text-sm text-muted-foreground space-y-1'>
            <li>
              • <strong>Super Admin</strong> always has all permissions and cannot be modified
            </li>
